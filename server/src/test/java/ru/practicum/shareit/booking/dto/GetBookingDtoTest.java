...
class GetBookingDtoTest {
    ...
    void shouldSerialize() throws IOException {
        ...
        assertThat(result).extractingJsonPathValue("$.status").isEqualTo(BookingStatus.APPROVED.toString());
    }

    @Test
    void shouldDeserialize() throws IOException {
        String content = "{\"id\":\"1\",\"start\":\"" + startTime + "\",\"end\":\"" + endTime + "\",\"status\":\"" + BookingStatus.APPROVED + "\"}";
